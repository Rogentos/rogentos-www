...
var parsePOSTfile     = 'PLUGINS/GEN_edit/parsePOST.php';    // scriptul dorit pt $.post()
...
function SaveEditITEM(id)     {
          ...
          val      = $('#GE_contDET > input[name=item_name]').val();
          itemTYPE = $('#GE_contDET > select[name=type]').val();
